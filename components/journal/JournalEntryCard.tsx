    ...
    <article className="border-border group relative space-y-3 rounded-2xl border bg-white/40 p-5 dark:bg-neutral-900/40">
      <header className="flex items-baseline justify-between gap-3">
        ...
        <button
          ...
          title={labels.delete}
          className="text-muted-foreground hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-950/30 rounded-full p-1.5 opacity-60 transition group-hover:opacity-100 disabled:opacity-30"
        >
      ...
      <div className="space-y-3">
        <div className="bg-primary/10 text-foreground rounded-2xl rounded-tl-md px-4 py-2.5 text-sm whitespace-pre-wrap">
          {question}
        </div>
